            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST" action="{{ route('organization.store_need') }}"
                        ...
                        <div class="col-md-12">
                            <label for="inputNameEn" class="form-label">Need Name</label>
                            <input type="text" name="item_name_en" class="form-control" id="inputNameEn"
                                value="{{ old('item_name_en') }}">
                        </div>

                        <div class="col-md-12">
                            <label for="inputDescriptionEn" class="form-label">Description</label>
                            <textarea name="description_en" class="form-control" id="inputDescriptionEn">{{ old('description_en') }}</textarea>
                        </div>
                        <div class="col-md-12">
                            <label for="inputNameAr" class="form-label">Need Name in Arabic</label>
                            <input type="text" name="item_name_ar" class="form-control" id="inputNameAr"
                                value="{{ old('item_name_ar') }}">
                        </div>

                        <div class="col-md-12">
                            <label for="inputDescriptionAr" class="form-label">Description in Arabic</label>
                            <textarea name="description_ar" class="form-control" id="inputDescriptionAr">{{ old('description_ar') }}</textarea>
                        </div>
