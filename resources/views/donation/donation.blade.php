                        ...
                        <div class="causes_content">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <span class="responFontSizeDonation"  style="font-size: 35px;">
                                    <strong>{{ __('Raised') }}:</strong> {{ $need->donated_quantity }}
                                    {{ $need->item_name }}
                                </span>
                                <span class="responFontSizeDonation"
                                    style="font-size: 35px; text-decoration: underline; text-decoration-color: #3CC78F; text-decoration-thickness: 4px;">
                                    <strong>{{ __('Goal') }}:</strong> {{ $need->quantity_needed }}
                                    {{ $need->item_name }}
                                </span>
                            </div>

                            <div class="causes_content d-flex justify-content-between align-items-start flex-wrap"
                                style="gap: 20px;">
                                <div class="responWidthDonation" style="width: 48%; font-size: 16px;">
                                ...
                                <div class="responWidthDonation" style="width: 48%; align-self: flex-start; margin-top: -120px;">
                                    <div class="make_donation_area section_padding">
                                        <div class="container">
                                            ...
                                            <div class="row justify-content-center" style="height: auto;">
                                                <div class="col-lg-12">
                                                    <form id="donation-form" action="{{ route('donate.store') }}"
                                                        method="POST" class="donation_form">
                                                        @csrf
                                                                    ...
                                                                    <div class="input_field">
                                                                        <div class="input-group">
                                                                            <div class="input-group-prepend">
                                                                                <span
                                                                                    class="input-group-text">{{ __('Max') }}</span>
                                                                            </div>
                                                                            <input type="text" class="form-control"
                                                                                placeholder="{{ $maxDonation }}" readonly>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <br>
                                                        <div class="login"
                                                            @if (auth()->check() || $need->status === 'Fulfilled') style="display: none;" @endif>
                                                            {{ __('You have to login first!') }} <a
